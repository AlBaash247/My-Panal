...
<head>
    ...
    <link rel="stylesheet" href="css/loging-form.css">
...
<body>
                ...
                <div class="shadow w-100 py-4 bg-white">
                    <div class="d-flex align-items-center w-100 topControlPanalItems">
                        ...
                        <div class="d-flex align-items-center justify-content-start p-0">
                            <a id="btnCredits" class="btn myBtnAccent topControlPanalItems text-uppercase"
                        ...
                        <div class="flex-grow-1 d-flex align-items-center justify-content-center">
                            ...
                            <div id="inputSearchGroup" class="input-group topControlPanalItems">
                                <input id="inputSearch" type="text" class="form-control bg-light"
                                    placeholder="search for a task Title/Decription/Tag"
                                    aria-label="search for a task Title/Decription/Tag">
                        ...
                        <div class="d-flex align-items-center  justify-content-end p-0">
                            ...
                            <!-- Menstions -->
                            <button id="btnMentions"
                                class="rounded-circle btn btn-sm myBtn position-relative text-white fs-5 me-4"
                                type="submit">
                                @
                                <span id="txtMenstions"
                            ...
                            <!-- AssignedToMe -->
                            <button id="btnAssignedToMe"
                                class="rounded-circle btn btn-sm myBtn position-relative text-white fs-5" type="submit">
                            ...
                            <div id="btnProfileGroup" class="dropdown topControlPanalItems">
                                <button class="circular_image btn myBtn dropdown-toggle p-0" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">

                                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#FFF"
                                        class="bi bi-person-fill" viewBox="8 0 7 24">
                                        <path
                                ...
                                <div class="card mySummaryCard myCardSecondry shadow p-3">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-fill justify-content-end">
                                            <p class="fs-4 text-black-50">Total Tasks: <strong
                                                    id="txtAllSpacesTotalTasks" class="text-black">73</strong> </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="labelProgressbarContainer align-items-center mb-2">
                                        ...
                                        <div id="progressbarAllSpacesTodoContainer"
                                            class="progress labelProgressbarChild2" role="progressbar"
                                            aria-label="Animated striped example" aria-valuenow="25" aria-valuemin="0"
                                            aria-valuemax="100" style="height: 28px;">

                                            <div id="progressbarAllSpacesTodo"
                                                class="progress-bar bgSecondary progress-bar-striped progress-bar-animated fs-5"
                                    ...
                                    <div class="labelProgressbarContainer align-items-center mb-2">
                                        ...
                                        <div class="progress labelProgressbarChild2" role="progressbar"
                                            aria-label="Animated striped example" aria-valuenow="75" aria-valuemin="0"
                                            aria-valuemax="100" style="height: 28px">

                                            <div id="progressbarAllSpacesInProgress"
                                                class="progress-bar bgAccent progress-bar-striped progress-bar-animated fs-5"
                                    ...
                                    <div class="labelProgressbarContainer  align-items-center mb-2">
                                        ...
                                        <div class="progress labelProgressbarChild2" role="progressbar"
                                            ...
                                            <div id="progressbarAllSpacesDone"
                                                class="progress-bar bg-primary progress-bar-striped progress-bar-animated fs-5"
                            ...
                            <div class="col-xxl-3 col-lg-6 col-md-12 mb-3">
                                <div class="card mySummaryCard myCardPrimary shadow p-3">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-fill justify-content-end">
                                            <p class="fs-4 text-black-50">Total Tasks: <strong
                                                    id="txtCurrentSpaceTotalTasks" class="text-black">38</strong> </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="labelProgressbarContainer  align-items-center mb-2">
                                        ...
                                        <div class=" progress labelProgressbarChild2" role="progressbar"
                                            ...
                                            <div id="progressbarCurrentSpaceTodo"
                                                class="progress-bar bgSecondary progress-bar-striped progress-bar-animated fs-5"
                                                style="width: 25%"> 25%</div>
                                        </div>
                                    ...
                                    <div class="labelProgressbarContainer  align-items-center mb-2">
                                        ...
                                        <div class=" progress labelProgressbarChild2" role="progressbar"
                                            ...
                                            <div id="progressbarCurrentSpaceInProgress"
                                                class="progress-bar bgAccent progress-bar-striped progress-bar-animated fs-5"
                                                style="width: 50%">50%</div>
                                        </div>
                                    ...
                                    <div class="labelProgressbarContainer  align-items-center mb-2">
                                        ...
                                        <div class=" progress labelProgressbarChild2" role="progressbar"
                                            ...
                                            <div id="progressbarCurrentSpaceDone"
                                                class="progress-bar bg-primary progress-bar-striped progress-bar-animated fs-5"
                                                style="width: 75%">75%</div>
                                        </div>
                            ...
                            <div class="col-xxl-3 col-lg-6 col-md-12 mb-3">
                                <div class="card mySummaryCard myCardAccent shadow p-3">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-fill justify-content-end">
                                            <p class="fs-4 text-black-50">Total Tasks: <strong
                                                    id="txtTitleAllSpaceDueToday" class="text-black">11</strong> </p>
                                        </div>
                                    </div>

                                    <div class>
                                        <p class="p-1"> Total Number of Due today tasks is<strong
                                                id="txtAllSpaceDueToday" class="ms-1">
                                                11</strong>,
                                        ...
                                        <div class="d-flex">
                                            <button id="btnDisplayAllSpacesDueToday"
                                                class="btn myBtnAccent bgAccent flex-fill text-uppercase mx-1">Display All Due
                                                Today</button>
                                            <button id="btnDisplayCurrentSpaceDueToday"
                                                class="btn myBtnAccent bgAccent flex-fill text-uppercase mx-1">Display Space Due
                                                Today</button>
                                        </div>
                            ...
                            <div class="col-xxl-3 col-lg-6 col-md-12 mb-3">
                                <div class="card mySummaryCard myCardPriorityHigh shadow p-3">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-fill justify-content-end">
                                            <p class="fs-4 text-black-50">Total Tasks: <strong
                                                    id="txtTitleAllSpacesHighPriority" class="text-black">6</strong>
                                            </p>
                                        </div>
                                    </div>

                                    <div class>
                                        <p class="p-1"> Total Number of High Priority tasks is<strong
                                                id="txtAllSpacesHighPriority" class="ms-1">
                                                6</strong>,
                                        ...
                                        <div class="d-flex">
                                            <button id="btnDisplyAllSpacesHighPriority"
                                                class="btn myBtnPriorityHigh bgAccent flex-fill text-uppercase mx-1">Display All
                                                High Priority</button>
                                            <button id="btnDisplyCurrentSpacesHighPriority"
                                                class="btn myBtnPriorityHigh bgAccent flex-fill text-uppercase mx-1">Display Space
                                                High Priority</button>
                                        </div>
                    ...
                    <div class="row justify-content-center px-5">
                        ...
                        <div class="col-12 px-4">
                            ...
                            <div class="card shadow p-2">
                                ...
                                <!-- top-section -->
                                <div
                                    class="d-flex topSectionContainer align-items-top w-100 py-2 px-3 border border-top-0 border-start-0 border-end-0 overflowXAuto">

                                    <div class="d-flex flex-fill justify-content-start">

                                        <div id="btnSelectedSpaceDropdown" class="dropdown">
                                            <button class="btn myBtnPrimary dropdown-toggle fs-4" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                Current Space
                                            </button>
                                            <ul class="dropdown-menu">
                                    ...
                                    <div class="d-flex flex-fill justify-content-end">
                                        <button id="btnFilterHighPriorityTask"
                                            class="btn myBtnSmall myBtnPriorityHigh text-uppercase mx-1">H</button>
                                        <button id="btnFilterMeduimPriorityTask"
                                            class="btn myBtnSmall myBtnPriorityMedium text-uppercase mx-1">M</button>
                                        <button id="btnFilterLowPriorityTask"
                                            class="btn myBtnSmall myBtnPriorityLow text-uppercase mx-1">L</button>

                                        <div class="dropdown mx-1">
                                            <button id="btnSortDropdown"
                                                class="btn myBtn myBtnFilter dropdown-toggle p-0" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false">

                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="#FFF" class="bi bi-person-fill" viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="#">Sort By Due Date (Decending) </a>
                                                </li>
                                                <li><a class="dropdown-item" href="#">Sort By ID (Ascending) </a></li>
                                                <li><a class="dropdown-item" href="#">Sort By ID (Decending) </a></li>
                                        ...
                                        <tbody class="table-group-divider myTasksTable">
                                            ...
                                            <tr>
                                                ...
                                                <td class="display-6 fs-4">
                                                    <div id="btnTaskPriority"
                                                        class="btn myBtnPriority myBtnPriorityLow mx-1">LOW
                                                    </div>
                                                <td class="display-6 fs-4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="display-6 fs-4">
                                                    <div id="btnTaskPriority"
                                                        class="btn myBtnPriority myBtnPriorityMedium mx-1">MEDUIM
                                                    </div>
                                                <td class="display-6 fs-4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="display-6 fs-4">
                                                    <div id="btnTaskPriority"
                                                        class="btn myBtnPriority myBtnPriorityHigh mx-1">HIGH
                                                    </div>
                                                <td class="display-6 fs-4">
    ...
    <!-- modal-login -->
    <div id="MyLoginModalOverlay" class="modal-overlay">
        <div id="MyLoginModal" class="modal">
            <!-- close modal -->
            <a id="btnMyLoginModalClose" class="close-modal">
